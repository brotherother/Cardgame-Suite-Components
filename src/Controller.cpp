...
#define FACTORY_VARIENT RUMMY
#define FACTORY_VARIENT SOLITAIRE
...
HWND hWnd_subwindow_textArea1;
HWND hWnd_subwindow_textArea2;

HWND hWnd_subwindow_stock;
HWND hWnd_subwindow_waste;
...
HWND hWnd_subwindow_tableau;
HWND hWnd_subwindow_spiderSolitaire;
HWND hWnd_subwindow_klondikeSolitarie;
	...
	PSTR szCmdLine, int iCmdShow)
{
	...
	CardAreaView::cardAreaViewDisplay(hInstance);

	IGame* newGame = new IGame();
	IGameView* gameview = new IGameView();
	gameview(newGame);
	...
	UINT msg, WPARAM wParam, LPARAM lParam) // describes the event
{
	...
	case WM_CREATE:  // for initialization that happens when window is created
		...
		hWnd_foundation = CreateWindow(szSubName,   // name of class that handles subwindow events
			NULL, // window caption
			...
			NULL);               // create params.
		SetWindowLong(hWnd_foundation, DWL_USER, (long)(myView1)); // associate a view object with this window


		// create the textArea1 subwindow
		hWnd_textArea1 = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_textArea1, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the textArea2 subwindow
		hWnd_textArea2 = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_textArea2, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the stock subwindow
		hWnd_stock = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_stock, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the waste subwindow
		hWnd_waste = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_waste, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the meldArea subwindow
		hWnd_meldArea = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_meldArea, DWL_USER, (long)(myView2)); // associate a view object with this window


		// create the playersHand subwindow
		hWnd_playersHand = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_playersHand, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the opponentsHand subwindow
		hWnd_opponentsHand = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_opponentsHand, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the tableau subwindow
		hWnd_tableau = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_tableau, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the spiderSolaire subwindow
		hWnd_spiderSolitaire = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_spiderSolitaire, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the klondikeSolitaire subwindow
		hWnd_klondikeSolitaire = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_klondikeSolitaire, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the rummy subwindow
		hWnd_rummy = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_rummy, DWL_USER, (long)(myView2)); // associate a view object with this window

		// create the ginRummy subwindow
		hWnd_ginRummy = CreateWindow(szSubName,    // name of class that handles subwindow events
			NULL, // window caption
			WS_CHILD | WS_VISIBLE, // window style
			20,       // init x pos
			350,       // init y pos
			...
			(HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE),           // program instance
			NULL);               // create params.
		SetWindowLong(hWnd_ginRummy, DWL_USER, (long)(myView2)); // associate a view object with this window
